    ...
    >
      ...
      <div className="container-default grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 py-20 px-4">
        ...
        <div className="flex flex-col gap-4 text-left">
          ...
          <a href="tel:+1224344555666" className="flex items-center gap-3 hover:text-black font-medium text-[16px] text-[#595959] font-['Poppins',_sans-serif]">
            ...
            <span>+1 224 344 55566</span>
          </a>

          <a href="mailto:info@wedhire@gmail.co" className="flex items-center gap-3 hover:text-black font-medium text-[16px] text-[#595959] font-['Poppins',_sans-serif]">
            ...
            <span>info@wedhire@gmail.co</span>
          </a>
